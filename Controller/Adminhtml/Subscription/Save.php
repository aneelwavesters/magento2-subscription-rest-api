...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Wavesters\Subscription\Model\Subscription::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('wavesters_subscription_subscription');
            ...
            $this->dataPersistor->set('wavesters_subscription_subscription', $data);
